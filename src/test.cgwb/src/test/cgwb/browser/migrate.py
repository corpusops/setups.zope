...
from test.cgwb.setuphandlers import setup_catalog
from test.cgwb import upgrades
...
class FileTestCgwbMigrator(BlobMigrator):
    src_portal_type = 'FileTestCgwb'
    src_meta_type = 'FileTestCgwb'
    dst_portal_type = 'FileTestCgwb'
    dst_meta_type = 'FileTestCgwb'


class TestCgwb_migrate(grok.View):
    ...
    def delete_path(self, path):
        ...
        try:
            ...
            upgrades.log(
                "Cannot delete %s because parent "
                "does not exist anymore" % path)
        return ret
    ...
    @onlyonce
    def to_blob_i(self):
        """To avoir conflicts during the plonemigration loop,
    ...
    def custom_hook_blob(self):
        self.migrate_fileTestCgwb_to_blob()
    ...
    def custom_hook_after_plone_upgrade(self):
        ...
        ps.runImportStepFromProfile(
            'profile-TestCgwb.skin:default', "skins", run_dependencies=False)
