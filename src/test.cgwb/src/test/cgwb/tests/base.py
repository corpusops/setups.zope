...
from test.cgwb.testing import (
    PLONE_MANAGER_NAME,
    TEST_USER_NAME,
    TEST_CGWB_SIMPLE as SIMPLE,
    TEST_CGWB_FIXTURE as UNIT_TESTING,
    TEST_CGWB_INTEGRATION_TESTING as INTEGRATION_TESTING,
    TEST_CGWB_FUNCTIONAL_TESTING as FUNCTIONAL_TESTING,
    TEST_CGWB_SELENIUM_TESTING as SELENIUM_TESTING,
)
