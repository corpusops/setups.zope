...
def upgrade_1000(context):
    ...
    #portal_setup.runImportStepFromProfile(
    #    'profile-test.cgwb:default', 'jsregistry', run_dependencies=False)
    #portal_setup.runImportStepFromProfile(
    #   'profile-test.cgwb:default', 'cssregistry', run_dependencies=False)
    #portal_setup.runImportStepFromProfile(
    #   'profile-test.cgwb:default', 'portlets', run_dependencies=False)
    #portal_setup.runImportStepFromProfile(
    #   'profile-test.cgwb:default', 'propertiestool', run_dependencies=False)
    log('v1000 applied')
