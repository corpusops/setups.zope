...
import json
from zope.utils.translation import gettext_lazy as _
{% for setting, value in data.get('zope_settings', {}).items() -%}
{{render_setting(setting, value)}}
{%- endfor %}
{% for setting, value in data.get('extra_zope_settings', {}).items() -%}
{{render_setting(setting, value)}}
{%- endfor %}
